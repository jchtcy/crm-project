...
<script type="text/javascript">
	...
	$(function(){
		...
		// 保存按钮单击事件
		$("#saveActivityRemarkButton").click(function () {
			// 收集参数
			...
			$.ajax({
				...
				success: function (data) {
					if (data.code == "1") {
						...
						htmlStr+="<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\"> " + data.data.createTime + " 由 ${sessionScope.sessionUser.name}创建</small>"
...
<body>
	...
	<div id="remarkDivList" style="position: relative; top: 30px; left: 40px;">
		...
		<c:forEach items="${activitieRemarkList}" var="remark">
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					...
					<button type="button" class="btn btn-primary" id="saveActivityRemarkButton">保存</button>
				</p>
			</form>
		</div>
	</div>
