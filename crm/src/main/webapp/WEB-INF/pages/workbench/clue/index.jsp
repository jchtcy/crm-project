...
<script type="text/javascript">
	...
	$(function(){
		...
		queryClueListByCondition();
		// 查询按钮添加单击事件
		$("#queryClueButton").click(function () {
			queryClueListByCondition();
		});
		//给"全选"按钮添加单击事件
	...
	function queryClueListByCondition() {
		//收集参数
		...
		$.ajax({
			url: "workbench/clue/getClueListByCondition.do",
			data: {
				fullname: fullname,
				company: company,
				phone: phone,
			...
			success: function (data) {
				if (data.code == "1") {
					...
					$.each(data.data, function (index, clue) {
						...
						htmlStr += "<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='workbench/clue/detailClue.do?id="+clue.id+"'\">"+ clue.fullname + clue.appellation +"</a></td>";
	...
	<div class="modal fade" id="editClueModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" id="saveEditActivityButton" class="btn btn-primary" data-dismiss="modal">更新</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <button type="button" id="queryClueButton" class="btn btn-default">查询</button>
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  ...
				  <button type="button" class="btn btn-default" id="editClueBtn" data-toggle="modal" data-target="#editClueModal"><span class="glyphicon glyphicon-pencil"></span> 修改</button>
